...
<body>
    <nav class="navbar navbar-expand-lg py-3" style="background-color: rgba(24, 27, 25, 1); border-bottom: 1px solid rgba(255, 255, 255, 0.12);">
        <div class="container">
            <a class="navbar-brand fw-bold" href="<?= BASEURL; ?>">
                <img src="<?= BASEURL; ?>assets/img/brand-logo.svg" alt="Brand Logo" class="img-fluid brand-logo" width="62">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav d-flex justify-content-between align-items-center w-100">
                    ...
                    <form action="" method="post">
                        <input type="text" class="input" placeholder="Searching movie.." style="width: 300px !important;">
                    </form>
    ...
    <main class="container mt-5">
        ...
        <section class="favorite" style="margin: 120px 0;">
            <h2 class="text-warning">Top 10 Film dari Recting</h2>
            <p class="text-light">Kumpulan fIlm terbaik di bulan Oktober!</p>
