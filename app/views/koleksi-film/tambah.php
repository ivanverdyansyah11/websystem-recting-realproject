...
<head>
    ...
    <title>Add New Collection Film Page | Recting Application</title>
                ...
                <div class="col p-0">
                    ...
                    <div class="content-dashboard">
                        ...
                        <div class="wrapper d-flex justify-content-between align-items-center mb-4">
                            <h4 class="title mb-0">Add New Collection Film</h4>
                        </div>
                        <form class="form" action="<?= BASEURL; ?>film/tambahAction" method="post" enctype='multipart/form-data'>
                            <div class="row mb-3">
                                <div class="col-3">
                                    <div class="form-group">
                                        <img src="<?= BASEURL; ?>assets/img/img-notfound.png" alt="Image Not Found" class="img-fluid mb-3 tag-thumbnail w-100">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input input-thumbnail" id="inputThumbnail" required name="thumbnail" style="position: absolute; top: -100px; left: -100px; opacity: 0;">
                                ...
                                <div class="col">
                                    <div class="input-group mb-3 d-flex flex-column">
                                        ...
                                        <input type="text" class="input" id="title" name="title" required placeholder="Enter your title..">
                                    </div>
                                    <div class="input-group mb-3 d-flex flex-column">
                                        <label for="actor">Actor</label>
                                        <input type="text" class="input" id="actor" name="actor" required placeholder="Enter your actor..">
                                    </div>
                                    <div class="input-group mb-3 d-flex flex-column">
                                        <label for="producer">Producer</label>
                                        <input type="text" class="input" id="producer" name="producer" required placeholder="Enter your producer..">
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="input-group d-flex flex-column">
                                                ...
                                                <input type="number" class="input" id="year_release" name="year_release" required placeholder="Enter your year release..">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="input-group d-flex flex-column">
                                                <label for="rating">Rating</label>
                                                <input type="text" class="input" id="rating" name="rating" required placeholder="Enter your rating..">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="input-group d-flex flex-column">
                                            ...
                                            <input type="text" class="input" id="trailer" name="trailer" required placeholder="Enter your trailer..">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-group d-flex flex-column">
                                        ...
                                        <textarea type="text" class="input" id="sinopsis" name="sinopsis" required placeholder="Enter your sinopsis.." rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4">
